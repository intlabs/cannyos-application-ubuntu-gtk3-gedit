#!/bin/sh
#
# CannyOS cannyos-application-ubuntu-gtk3-gedit container build script
#
# https://github.com/intlabs/cannyos-application-ubuntu-gtk3-gedit
#
...
#
clear
curl https://raw.githubusercontent.com/intlabs/cannyos-application-ubuntu-gtk3-gedit/master/CannyOS/CannyOS.splash
#     *****************************************************
#     *                                                   *
#     *        _____                    ____  ____        *
...
sudo mkdir -p "/CannyOS/build/cannyos-application-ubuntu-gtk3-gedit"
# Ensure that there it is clear
sudo rm -r -f "/CannyOS/build/cannyos-application-ubuntu-gtk3-gedit/*"
...
sudo docker run -i -t --rm \
 ...
 --user "root" \
 -p 80 \
 intlabs/cannyos-application-ubuntu-gtk3-gedit 
